...
import com.snackviet.dto.payos.CreatePaymentLinkRequestBody;
...
public class ApiPayOs {
    ...
    public ObjectNode getMethodName(@PathVariable String id) {
        ObjectMapper objectMapper = new ObjectMapper();
        ObjectNode response = objectMapper.createObjectNode();

        try {
            PaymentLinkData order = payOS.getPaymentLinkInformation(Long.valueOf(id));

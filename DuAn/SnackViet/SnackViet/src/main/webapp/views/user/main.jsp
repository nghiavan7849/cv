	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<a href="${request.contextPath}/san-pham" class="btn btn-primary">Đặt Hàng Ngay</a>
			</div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <span class="product-price">${product.gia} VND </span>
                    <a class="btn btn-success" style="margin: 0 0 0 60px; width: 110px;" href="${request.contextPath}/gio-hang/mua-hang/dat-hang?idSP=${product.maSanPham}">Mua ngay</a>
                </div>
            </div>
        </div>
    </c:forEach>

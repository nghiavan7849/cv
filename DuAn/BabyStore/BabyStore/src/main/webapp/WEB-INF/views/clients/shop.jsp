		...
		<div class="container py-5">
			...
			<div class="row g-4">
				<div class="col-lg-12">
					<div class="row g-4">
						<div class="col-xl-3">
							<form action="/user/result" method="get">
								<div class="input-group w-100 mx-auto d-flex">
									<input type="search" class="form-control p-3"
										placeholder="keywords" aria-describedby="search-icon-1"
										name="keyword"> <span id="search-icon-1"
										class="input-group-text p-3"> <i class="fa fa-search"></i>
									</span>
								</div>
							</form>
						</div>
						...
						<div class="col-xl-3">
							<div
								...
								<label for="fruits">Default Sorting:</label> <select id="fruits"
									name="fruitlist" class="border-0 form-select-sm bg-light me-3"<%--form="fruitform"--%>>
					...
					<div class="row g-4">
						<div class="col-lg-3">
							<div class="row g-4">
								...
								<div class="col-lg-12">
									<div class="mb-3">
										<form action="/user/shop/query" method="get">
											<h4 class="mb-2">Price</h4>
											<input type="range" class="form-range w-100" id="rangeInput"
												name="total" min="0" max="1000000" value="0"
												oninput="amount.value=total.value">
											<output id="amount" name="amount" min-velue="0"
												max-value="10000" for="total">0 </output>
								...
								<div class="rounded position-relative fruite-item">
									...
									<div
										...
										<div class="d-flex justify-content-between flex-lg-wrap">
											...
											<a href="/user/shop-detail?id=${item.id}"
						...
						<div class="col-12">
							<div class="pagination d-flex justify-content-center mt-5">
								...
								<c:forEach begin="0" end="${totalPages - 1}" var="i">
									<a href="?page=${i}&size=${pageSize}" class="rounded">${i + 1}</a>
								</c:forEach>

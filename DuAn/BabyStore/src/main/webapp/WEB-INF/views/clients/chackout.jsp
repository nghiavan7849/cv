...
<html>
<head>
    <title>BabyStore - Chackout</title>
</head>
<body>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center mt-2">
                                        <img src="<c:url value='img/vegetable-item-2.jpg'/>" class="img-fluid rounded-circle"
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center mt-2">
                                        <img src="<c:url value='img/vegetable-item-5.jpg'/>" class="img-fluid rounded-circle"
                                             style="width: 90px; height: 90px;" alt="">
                                    </div>
                                </th>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center mt-2">
                                        <img src="<c:url value='img/vegetable-item-3.png'/>" class="img-fluid rounded-circle"
                                             style="width: 90px; height: 90px;" alt="">
                                    </div>
                                </th>

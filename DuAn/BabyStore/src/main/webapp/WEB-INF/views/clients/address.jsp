                            ...
                            <form>
                                    ...
                                    <div class="d-flex justify-content-between div-input">
                                        <div class="input-box">
                                            <div class="input-dau"> 
                                                ...
                                                <input type="text" placeholder="Họ và tên" name="hoVaTen" value="${sessionScope.sessionTaiKhoan}"><br>
                                ...
                                <div class="d-flex justify-content-center" >
                                    <div class="" style="width: 700px;">
                                        <input type="checkbox" name="macDinhDC" value="true" ${diaChi.status?'checked':''} id=""> Đặt làm địa chỉ mặc định
                                    </div>   
                                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>   
                            	<c:forEach var="d" items="${listDiaChi}">
	                                <tr class="row">
	                                    <td class="col-md-3 text-center ">${d.account.fullName}</td>
	                                    <td class="col-md-2 text-center ">${d.numberPhone}</td>
	                                    <td class="col-md-4 text-center ">${d.fullNameAddress}</td>
	                                    ...
	                                    <td class="col-md-2 text-center ">
	                                        <a href="${request.contextPath}/dia-chi/edit/${d.id}"><i class="fa-solid fa-pencil" style="color: #0091ff;"></i></a> <i>|</i>
	                                        <a data-bs-toggle="modal" data-bs-target="#xoaDiaChi" data-name="${d.fullNameAddress}" data-id="${d.id}"><i class="fa-solid fa-trash-can" style="color: #ff0000;"></i></a>
	                                    </td>
	                                </tr>
                                </c:forEach>
                            </tbody>
